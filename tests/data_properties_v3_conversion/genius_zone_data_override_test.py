...
from geniushubclientalt.const import ZONE_MODE, ZONE_TYPE
...
class GeniusZoneDataOverrideTests(unittest.TestCase):
    ...
    def test_when_override_applicable_for_iType_set_and_setpoint_is_zero_then_override_is_none(
        ...
        test_values = {ZONE_TYPE.OnOffTimer, ZONE_TYPE.ControlSP, ZONE_TYPE.TPI}
    ...
    def test_when_override_applicable_for_iType_set_and_setpoint_is_not_zero_then_override_duration_is_set(
        self,
    ):  # noqa: E501
        "Check that the override property is not set to None"
